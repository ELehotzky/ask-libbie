...
parseResources = (resources) => {
  ...
  let g = this.state.locations;

  // console.log(g[0].name)
  Promise.all([googleMapsPromise, g]).then(values => {
...
//   const { locationsCopy , editFormTest, editFormData } = this.state;
  ...
  // let test = marker.find(mark => mark.name === editFormTest)
  // console.log(marker)
...
//       this.setState({
//         editFormData: num
//         // editResource: editFormTest
//       })
//       console.log("editFormData: " + num)
//     }
//   }
// }
